...
<html>
    ...
    <body>
          ...
          <h2 class="heading"><span aria-hidden="true" class="icon-menu-03"></span> ${report.title}</h2>
            <div class="right-icon text-right">Cultivate</div>
                    ...
                    <g:each in="${param}" var="entry" >
                      ...
                      <g:else>
                        ...
                        ${ entry.key == 'item.spec'?'class=maxw-12':''}>
                            <g:if test="${entry.key=='view.reportViewer.cultivate.batchOperation.endDate'}">

...
class OutSrcPurchaseReturnSheet {
    ...
    static hasMany = [details: OutSrcPurchaseReturnSheetDet]
    ...
    public String toString() {
        ...
        "${getMessageSource().getMessage("${i18nType}.outSrcPurchaseReturnSheet.label", args, Locale.getDefault())}: " +
        "${typeName}-${name}"
    }
    ...
    static validator = { col, obj ->
        ...
        if (obj.details) {
            ...
            obj.details.find { detail ->
                if (obj.executionDate < detail.outSrcPurchaseSheetDet.header.executionDate) {
                    result = true 
                }

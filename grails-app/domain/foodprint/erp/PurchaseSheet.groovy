...
class PurchaseSheet {
    ...
    static hasMany = [details: PurchaseSheetDet]
    ...
    public String toString() {
        ...
        "${getMessageSource().getMessage("${i18nType}.purchaseSheet.label", args, Locale.getDefault())}: " +
        "${typeName}-${name}"
    }
    ...
    static validator = { col, obj ->
        ...
        if (obj.details) {
            ...
            obj.details.find { detail ->
                def returnDetails = PurchaseReturnSheetDet.findAllByPurchaseSheetDetAndSite(detail, obj.site)

...
class OutSrcPurchaseReturnSheetDetController{
    ...
    def index = {
        ...
        def returnSheet = OutSrcPurchaseReturnSheet.get(params.header.id)

        if (returnSheet) {

            params.criteria = { eq('header', returnSheet) } >> params.criteria

            def list = OutSrcPurchaseReturnSheetDet.createCriteria().list(params, params.criteria)
    ...
    def show = {
        ...
        def returnSheetDet = OutSrcPurchaseReturnSheetDet.get(params.id)
    ...
    def create = {
        ...
        if (params.header.id) {
            ...
            def returnSheetDet = new OutSrcPurchaseReturnSheetDet(params)
    ...
    def update() {
        ...
        try {
            ...
            def newReturnSheetDet = new OutSrcPurchaseReturnSheetDet(params)
            def oldReturnSheetDet = OutSrcPurchaseReturnSheetDet.get(params.id)
